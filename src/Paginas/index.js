    ...
    return(
        ...
        <div>
            ...
            <section className="hero">
                ...
                <font size={8}>Se Parte de Nosotros!</font>
                <br />
                <br />
                <br />
                ...
                <br />
                <br />
                <font size={4}>Inicia Sesion o Registrate</font>
                <br />
                <br />
                <font size={4}>Tu mascota también tiene derecho a tener un buen bienestar</font>
                <br />
                <br />
                <Link to="" className="button">Entra Ahora</Link>
                <br />
                <br />
                <h4>Nustras redes Sociales</h4>
                <a href="https://web.whatsapp.com/"><i className="fa-brands fa-whatsapp" /></a>
                <a href="https://www.instagram.com/guarderia_parceritos_fieles?igsh=eXBxaTIxbGg2NXpi"><i className="fa-brands fa-instagram" /></a>
                <a href="https://www.facebook.com/profile.php?id=61555383941250"><i className="fa-brands fa-facebook-f" /></a>
                <a href="https://www.tiktok.com/@parceritosfieles?_t=8oLcvrq6wh3&_r=1"><i className="fa-brands fa-tiktok" /></a>
                </div>
            ...
            <section className="services" id="servicio">
                ...
                <div className="services-grid">
                    ...
                    <img src="img/guarderia.png" alt="Guardia" />
                    <h3>Guarderia</h3>
                    ...
                    <div className="service">
                    <img src="img/colegio.png" alt="Colegio" />
                    <h3>Colegio</h3>
                    ...
                    <div className="service">
                    <img src="img/hotel.png" alt="Hotel" href="Gestion_Reserva/crear.html" />
                    <h3>Hotel</h3>
            ...
            <section className="contact" id="contacto">
                ...
                <div className="card" style={{width: 200}} id="carta">
                    ...
                    <span>
                        <i className="fa-solid fa-phone"><a href="tel:3103409688">3103409688</a>
                        </i>
                    </span>
                    </div>
                </div>
